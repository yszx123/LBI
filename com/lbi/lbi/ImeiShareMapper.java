...
//@author bailu
public class ImeiShareMapper extends Mapper<Text, Text> {
	String imei_share;

	public void setup(MapContext<Text, Text> context) throws IOException,
			InterruptedException {
		imei_share = "888888888888888,null::null,352315050191630,null.10000:CMCC,null.10000:中国移动:,111111111111111,Unknown,null.10000::,0,null.10000::null,:4.0.4:CNLAUNCH:yuanzheng77_3778:600*976:WIFI,004999010640000,352273017386340,null.10000:MY CELCOM:,null.10000:中国联通:,null.10000:中國移動:,354847011887169";
	...
	public void map(LongWritable recnum, Record record,
		...
		if (imei.length() >= 15) {
			...
			if (!imei.substring(14, 15).matches("^[0-9]*$")
